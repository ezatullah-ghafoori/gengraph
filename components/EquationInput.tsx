...
const EquationInput: React.FC<EquationInputProps> = ({
  ...
  return (
    <form className="w-full flex justify-around items-center" onSubmit={handleSubmit}>
      <input type='color' className='rounded-full border-none outline-none w-[25px] flex-[0.1] mr-3 h-[25px]' value={color} onChange={(e) => {
